...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (password.length < 8) {
            showErrorAlert('Password must be at least 8 characters', 'Validation Error');
            return;
        }
            ...
            >
                <div className="w-full h-full flex">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
                            ...
                            >
                                ...
                                >
                                    Create your account and unlock a world of possibilities with our platform
                                </motion.p>
                    ...
                    <motion.div
                        ...
                        className="w-full md:w-1/2 bg-white/5 backdrop-blur-sm overflow-y-auto"
                        style={{
                            scrollbarWidth: 'thin',
                            scrollbarColor: '#a60054 rgba(255, 255, 255, 0.1)'
                        }}
                    >
                        <style jsx>{`
                            ...
                            div::-webkit-scrollbar-thumb {
                                background: linear-gradient(180deg, #a60054 0%, #211f60 100%);
                                border-radius: 10px;
                            }
                            div::-webkit-scrollbar-thumb:hover {
                                background: linear-gradient(180deg, #c91069 0%, #2d2a80 100%);
                            }
                        `}</style>
