                                ...
                                >
                                    ...
                                    <div className="relative">
                                        <motion.input
                                            ...
                                            onBlur={() => setFocusedInput(null)}
                                            required
                                            className="w-full px-4 py-4 pr-12 bg-white/10 border-2 rounded-xl text-white placeholder-white/40 focus:outline-none transition-all duration-300 backdrop-blur-sm"
                                            style={{
